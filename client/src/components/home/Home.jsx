      ...
      <section className={`${styles.section} ${styles.roadmapSection}`}>
        ...
        <div className={styles.careersContainer}>
          <div className={styles.career}>
            ...
            <p>Explore the art of user interaction with Front-End Development. Learn to create seamless user experiences, design intuitive interfaces, and bring websites to life</p>
          </div>
          <div className={styles.career}>
            <h3>Back-end career path</h3>
            <p>Delve into the heart of web technology with Back-End Development.Discover the world of server-side programming like databases and server management</p>
          </div>
          <div className={styles.career}>
            <h3>Software engineer career path</h3>
            <p>Embark on a transformative journey in Software Engineering. Master the art and science of developing high-quality software solutions</p>
          </div>
        </div>
