import { getCompanyData } from "@/redux/features/user/userProfileSlice";
import { useRouter } from "next/router";
import { useEffect } from "react";
import { useForm } from "react-hook-form";
import { useDispatch, useSelector } from "react-redux";
import { Button } from "../ui/button";
import { CompanyLogin } from "@/redux/features/company/companyLoginSlice";

const CompanySignin = () => {
  const router = useRouter();
  const status = useSelector((state) => state.companyLogin.status);
  const form = useForm();
